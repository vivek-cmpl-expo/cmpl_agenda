  ...
  return (
    <section id="register" className="relative z-10 py-16 sm:py-28 md:py-36 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <AppImage
          src="/assets/banner/_IXO1577.jpg"
          alt="CMPL Expo event at Jio World Convention Centre"
          fill
        ...
        <div
          ...
          style={{
            background:
              'linear-gradient(to top, rgba(10,8,6,0.96) 0%, rgba(10,8,6,0.80) 50%, rgba(10,8,6,0.65) 100%)',
          }}
        />
        ...
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse at 30% 70%, rgba(184,134,11,0.1) 0%, transparent 60%)',
          }}
        />
      </div>
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-4 sm:px-6 md:px-12">
        <div className="max-w-4xl">
          ...
          <div className="flex items-center gap-4 mb-8 scroll-reveal">
            <span className="section-label" style={{ color: '#C8A84B' }}>
              09 / Join CMPL Expo
            </span>
          ...
          <p
            className="text-base sm:text-xl leading-relaxed mb-6 sm:mb-10 max-w-2xl scroll-reveal delay-1"
            style={{ color: 'rgba(255,255,255,0.7)' }}
          >
            Asia's largest contract manufacturing and private label platform. 4–6 May 2026 at Jio
            World Convention Centre, Mumbai.
          </p>
          ...
          <div className="flex flex-wrap gap-4 scroll-reveal delay-2">
            <a
              ...
              className="btn-gold relative px-8 py-4 text-sm font-bold tracking-widest uppercase"
            >

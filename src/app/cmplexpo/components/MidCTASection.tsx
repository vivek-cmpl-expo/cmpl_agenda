    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div
          ...
          style={{
            background:
              'linear-gradient(135deg, rgba(245,243,238,0.97) 0%, rgba(245,243,238,0.90) 50%, rgba(245,243,238,0.97) 100%)',
          }}
        />
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-4 sm:px-6 md:px-12 text-center">
        {/* Label */}
        <div
        ...
        >
          ...
          />
          <span className="section-label" style={{ color: '#8B6508' }}>
        ...
        <p className="text-expo-muted text-lg leading-relaxed mb-4 max-w-2xl mx-auto scroll-reveal delay-1">
          Join 30,000+ industry leaders, founders, and innovators at CMPL Expo 2026. Connect with
          verified buyers, discover manufacturers, and close real business deals.
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-4 scroll-reveal delay-2">
          <a
            ...
            className="btn-gold relative px-8 py-4 text-base font-bold tracking-wide"
          >
